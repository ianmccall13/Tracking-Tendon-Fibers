...
7. To retrieve the output of the program click on the "Folder" icon on the left tool bar and click the OUTPUT folder. This folder will have every frame processed by the program, the video of the annotated sequence at your specified fps, and the 3D reconstruction files, these is a Point3DReconstruction.ply and a Mesh3DReconstruction.ply, the first being just a point cloud in the shape of the tendons the second being a mesh surrounding the fascicles. These ply files can be downloaded and opened in any program at your disposal that can view plys. points3D.npz is also in the outputs and is just an archive of all the points for the reconstruction, you may want this if you intend to create your own mesh for the point cloud. 
## Trouble Shooting
